...
export default function CarouselArrows({
  ...
  return (
    <Stack direction="row" alignItems="center" display="inline-flex" sx={sx} {...other}>
      <StyledIconButton filled={filled} shape={shape} onClick={onPrev} {...leftButtonProps} sx={{color: (theme)=> theme.palette.mode === 'light' ? '' : theme.palette.primary.light}}>
        <LeftIcon icon={icon} isRTL={isRTL} />
      </StyledIconButton>

      <StyledIconButton filled={filled} shape={shape} onClick={onNext} {...rightButtonProps}  sx={{color: (theme)=> theme.palette.mode === 'light' ? '' : theme.palette.primary.light}}>
        <RightIcon icon={icon} isRTL={isRTL} />
      </StyledIconButton>
    </Stack>
  );
