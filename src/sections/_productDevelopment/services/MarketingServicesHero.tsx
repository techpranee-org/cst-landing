          ...
          <Grid xs={12} md={8}>
            ...
            >
              <Typography variant="h1">
                {" "}
                <Typography>Web / Mobile </Typography>Application Development
                Services
              </Typography>

              <Typography sx={{ opacity: 0.72 }}>
                At Techpranee, we specialize in guiding your ideas through the
                intricate journey of product development, from inception to
                realization.
              </Typography>
            </Stack>
