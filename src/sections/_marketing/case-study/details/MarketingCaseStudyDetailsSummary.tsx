...
export default function MarketingCaseStudyDetailsSummary({ projectData }: any) {
  ...
  return (
    ...
    >
      <Stack spacing={2}>
        ...
        <Typography variant="h6">{projectData?.attributes?.Name}</Typography>

        {/* <Typography variant="body2">{projectData.attributes.body}</Typography> */}
      </Stack>
      ...
      <Stack spacing={1}>
        ...
        <Link
          variant="body2"
          color="inherit"
          href={projectData?.attributes?.url}
          target="_blank"
        >
          {projectData?.attributes?.url}
        </Link>
        ...
        <Typography variant="body2" sx={{ pb: 1 }}>
          {projectData?.attributes?.Category}
        </Typography>
