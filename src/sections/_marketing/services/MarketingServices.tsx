      ...
      <Grid container spacing={3} justifyContent="space-between" alignItems="center">
        ...
        <Grid xs={12} md={6} lg={6}>
          <Stack spacing={3} sx={{ mb: 5 }}>
            ...
            Our suite of startup services is designed to empower you with a strong brand identity, compelling design, and seamless user experiences that will set you apart in the competitive landscape.
            </Typography>
