      ...
      <Container>
        <Grid container spacing={3} justifyContent="center">
          <Grid xs={12} md={8}>
            ...
            >
              <Typography variant="h1">Grow your brand</Typography>

              <Typography sx={{ opacity: 0.72 }} component={"h2"}>
                Welcome toTechpranee, an online advertising agency, where
                creativity meets strategy and innovation meets impact.
              </Typography>
            </Stack>
