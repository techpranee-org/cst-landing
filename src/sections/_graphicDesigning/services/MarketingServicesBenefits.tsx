...
const BENEFITS = [
  {
    ...
    description: 'Professional designs establish a consistent and memorable brand identity.',
    iconColor: 'primary',
  },
  {
    title: 'Effective Communication',
    description: ' Graphics simplify complex information for clearer messaging.',
    iconColor: 'success',
  },
  {
    title: 'Enhanced Marketing',
    description: 'Well-designed materials capture attention and communicate value.    ',
    iconColor: 'secondary',
  },
  {
    title: 'Engaging Content',
    description: 'Graphics for digital platforms increase user engagement.',
    iconColor: 'secondary',
  },
  {
    title: 'Consistency',
    description: ' Designers ensure visuals are uniform across all channels.',
    iconColor: 'success',
  },
  {
    title: 'Creativity and Credibility',
    description: 'Customized designs enhance creativity and boost brand credibility.',
    iconColor: 'primary',
  },
];
  ...
  return (
    ...
    >
      <Container>
        ...
        >
          From eye-catching graphics to cohesive branding, discover how our graphic designing services enhance user experience and contribute to long-term brand loyalty
        </Typography>
