...
const validationSchema = Yup.object().shape({
  ...
  name: Yup.string().required("BarndName is required"),
      ...
      <Container>
        <Grid container spacing={3} justifyContent="center">
          <Grid xs={12} md={8}>
            ...
            >
              <Typography variant="h1">Creative Design Services</Typography>

              <Typography sx={{ opacity: 0.72 }}>
                Transform your ideas to reality !
              </Typography>
              <Typography sx={{ opacity: 0.72 }}>
                In today's visually-driven world, standing out requires more
                than just words – it demands captivating visuals that tell your
                brand's story. Let techpranee be your creative partner in
                transforming ideas into stunning visuals that leave a lasting
                impact.
              </Typography>
            </Stack>
