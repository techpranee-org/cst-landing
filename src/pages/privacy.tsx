...
export default function ComingSoonPage() {
    return (
        <>
            <Head>
                <title>Privacy Policy - Techpranee</title>
                <meta name="description" content="Privacy Policy for Tech Pranee" key="privacy" />
                ...
                <section>
                    ...
                    <div style={{padding : '20px'}}>
                        <h1 style={{textAlign: 'center'}}>
                            <strong>
                                <u>Privacy Policy for Tech Pranee</u>
                            </strong>
                        </h1>
                        <p>
                            At techpranee.com, accessible from http://techpranee.com, one of our main priorities is the
                                                    privacy of our visitors. This Privacy Policy document contains types of information that is
                                                    collected and recorded by techpranee.com and how we use it.</p>
                        <p>
                            If you have additional questions or require more information about our Privacy Policy, do not
                                                    hesitate to contact us.</p>
                        <p >
                            This Privacy Policy applies only to our online activities and is valid for visitors to our
                                                    website with regards to the information that they shared and/or collect in techpranee.com. This
                        ...
                        <ul>
                            ...
                            <li>Communicate with you, either directly or through one of our
                                                            ...
                                                            relating to the webste, and for marketing and promotional purposes</li>
                        ...
                        <p>
                            techpranee.com follows a standard procedure of using log files. These files log visitors when
                        ...
                        <p>
                            Like any other website, techpranee.com uses 'cookies'. These cookies are used to store
                        ...
                        <p>
                            For more general information on cookies, please read&nbsp;<a href="https://web.archive.org/web/20210622002905/https://www.cookieconsent.com/what-are-cookies/">"What
                                                            Are Cookies"</a>.</p>
                        <h2>
                        ...
                        <p>
                            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                                                    that are used in their respective advertisements and links that appear on techpranee.com, which
                        ...
                        <p >
                            Note that techpranee.com has no access to or control over these cookies that are used by
                                                    third-party advertisers.</p>
                        <h2>
                            <strong>Third Party Privacy Policies</strong>
                        </h2>
                        <p >
                            techpranee.com's Privacy Policy does not apply to other advertisers or websites. Thus, we
                        ...
                        <p>
                            Another part of our priority is adding protection for children while using the internet. We
                                                    ...
                                                    online activity.</p>
                        <p >
                            techpranee.com does not knowingly collect any Personal Identifiable Information from children
