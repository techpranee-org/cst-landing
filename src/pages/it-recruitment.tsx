...
import ITReqcruitmentView from 'src/sections/it-recruitment/view/it-recruitment-view';
// sections

// ----------------------------------------------------------------------

ITCareRecruitmentPage.getLayout = (page: React.ReactElement) => <MainLayout>{page}</MainLayout>;

// ----------------------------------------------------------------------

export default function ITCareRecruitmentPage() {
  return (
    <>
      <Head>
